            ...
            <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
              ...
              <label className="flex flex-col gap-2">
                ...
                >
                  ...
                  <option value="De tasseling of maize">De tasseling of maize</option>
                  <option value="Crop Monitoring">Crop Monitoring</option>
                  <option value="Agri-Analytics">Agri-Analytics</option>
                </select>
              </label>
              <label className="flex flex-col gap-2">
                <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">Your Message</span>
                <textarea 
                  className="form-textarea rounded-lg border-slate-200 dark:border-slate-700 dark:bg-slate-800 focus:border-primary focus:ring-primary resize-none p-4 border" 
